...
* Установите модуль зависимостей **[ThreadJob](https://github.com/PaulHigin/PSThreadJob)**: `Install-Module -Name ThreadJob` \

* Установите сам модуль: `Install-Module -Name PortCheck`
